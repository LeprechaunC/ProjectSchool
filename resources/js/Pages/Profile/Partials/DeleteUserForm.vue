    ...
    <section class="profile-section">
        <header>
            ...
            <p class="profile-section-description">
                Kad jūsu konts būs dzēsts, visi tā resursi un dati tiks neatgriezeniski dzēsti. Pirms konta dzēšanas, lūdzu, lejupielādējiet visus datus vai informāciju, ko vēlaties saglabāt.
            </p>
        </header>
            ...
            <div class="p-6">
                ...
                <div class="mt-4 p-4 rounded-md bg-red-50 dark:bg-red-900/30 text-red-800 dark:text-red-300 text-sm">
                    <div class="flex">
                        ...
                        <p>
                           Kad jūsu konts būs dzēsts, visi tā resursi un dati tiks neatgriezeniski dzēsti. Lūdzu, ievadiet savu paroli, lai apstiprinātu, ka vēlaties neatgriezeniski dzēst savu kontu.
                        </p>
                    </div>
                </div>
